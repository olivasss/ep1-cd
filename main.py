...
class PokeSpider(scrapy.Spider):
  ...
  def parser_pokemon(self,response):
    ...
    habilidadenome = response.css('#tab-basic-16 > div:nth-child(1) > div:nth-child(2) > table > tbody > tr:nth-child(6) > td > span:nth-child(-n+5) > a::text')
    habilidadelink = response.css('#tab-basic-16 > div:nth-child(1) > div:nth-child(2) > table > tbody > tr:nth-child(6) > td > span:nth-child(-n+5) > a::attr(href)')
